...
class Atende(models.Model):
    ...
    class Meta:
        ...
        verbose_name = 'Médico x convênio'
        verbose_name_plural = 'Médicos x convênios'

    def __str__(self):
        return f'{self.medico} x {self.convenio}'
...
class Medico(models.Model):
    ...
    idamb = models.ForeignKey(Ambulatorio, models.DO_NOTHING, db_column='idamb', blank=True, null=True)
    convenios = models.ManyToManyField(Convenio, 'medico', through='Atende')
